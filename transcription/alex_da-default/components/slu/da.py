...
from alex_da.components.slu.exceptions import SLUException, DialogueActItemException
from alex_da.ml.exceptions import NBListException
from alex_da.corpustools.wavaskey import load_wavaskey
from alex_da.ml.features import Abstracted, Features, AbstractedTuple2
from alex_da.ml.hypothesis import Hypothesis, NBList, ConfusionNetwork
from alex_da.utils.text import split_by
    ...
    def category_label2value(self, catlabs=None):
        ...
        Arguments:
            catlabs: an optional mapping of category labels to tuples (slot
                     ...
                     alex_da.components.slu:SLUPreprocessing
...
class DialogueActHyp(SLUHypothesis):
    ...
    def get_da_nblist(self):
        ...
        # Error:
        #  File "/a/LRC_TMP/oplatek/vystadial/alex_da/components/hub/slu.py", line 119, in run
        #  self.read_asr_hypotheses_write_slu_hypotheses()
        #  File "/a/LRC_TMP/oplatek/vystadial/alex_da/components/hub/slu.py", line 98, in read_asr_hypotheses_write_slu_hypotheses
